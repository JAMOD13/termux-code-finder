...
echo -e "\033[1;36m    🤖 INITIALIZING MASTER BOT SYSTEM 🤖 \033[0m"
echo -e "\033[1;35m========================================\033[0m"

# 1. Storage Permission Check
if [ ! -d "/sdcard/Download" ]; then
    echo -e "[\033[1;33m!\033[0m] Storage ki permission chahiye. Please pop-up me 'Allow' karein..."
...
if ! command -v python &> /dev/null; then
    echo -e "[\033[1;34m⚙️\033[0m] Python install ho raha hai..."
    pkg install python -y
fi

# 3. Create/Update Python Core Bot File Automatically
cat << 'PYEOF' > bot.py
